...
| [`04_feature_engineering.ipynb`](04_feature_engineering.ipynb) | As-of, opponent-adjusted features + ablation and interaction tests → `data/processed/team_games.parquet` | v1 done (score-only) |
